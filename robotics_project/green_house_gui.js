...
document.getElementById("growBed1").innerHTML = `<td>`+growBed1["daysSincePlanted"]+` days</td>
                                                 <td`+((growBed1["soilMoisture"]>=100) ? ` style = color:red;`:'')+`>`+growBed1["soilMoisture"]+` cb moisture</td>
...
document.getElementById("growBed2").innerHTML = `<td>`+growBed2["daysSincePlanted"]+` days</td>
                                                 <td`+((growBed2["soilMoisture"]>=100) ? ` style = color:red;`:'')+`>`+growBed2["soilMoisture"]+` cb moisture</td>
...
document.getElementById("growBed3").innerHTML = `<td>`+growBed3["daysSincePlanted"]+` days</td>
                                                 <td`+((growBed3["soilMoisture"]>=100) ? ` style = color:red;`:'')+`>`+growBed3["soilMoisture"]+` cb moisture</td>
...
document.getElementById("growBed4").innerHTML = `<td>`+growBed4["daysSincePlanted"]+` days</td>
                                                 <td`+((growBed4["soilMoisture"]>=100) ? ` style = color:red;`:'')+`>`+growBed4["soilMoisture"]+` cb moisture</td>
...
document.getElementById("growBed5").innerHTML = `<td>`+growBed5["daysSincePlanted"]+` days</td>
                                                 <td`+((growBed5["soilMoisture"]>=100) ? ` style = color:red;`:'')+`>`+growBed5["soilMoisture"]+` cb moisture</td>
...
document.getElementById("growBed6").innerHTML = `<td>`+growBed6["daysSincePlanted"]+` days</td>
                                                 <td`+((growBed6["soilMoisture"]>=100) ? ` style = color:red;`:'')+`>`+growBed6["soilMoisture"]+` cb moisture</td>
...
document.getElementById("hydroponic1").innerHTML = `<td>`+hydroponic1["daysSincePlanted"]+` days</td>
                                                    <td`+((hydroponic1["nutrients"]=="low in nutrients") ? ` style = color:red;`:'')+`>`+hydroponic1["nutrients"]+`</td>
...
document.getElementById("hydroponic2").innerHTML = `<td>`+hydroponic2["daysSincePlanted"]+` days</td>
                                                    <td`+((hydroponic2["nutrients"]=="low in nutrients") ? ` style = color:red;`:'')+`>`+hydroponic2["nutrients"]+`</td>
...
document.getElementById("hydroponic3").innerHTML = `<td>`+hydroponic3["daysSincePlanted"]+` days</td>
                                                    <td`+((hydroponic3["nutrients"]=="low in nutrients") ? ` style = color:red;`:'')+`>`+hydroponic3["nutrients"]+`</td>
